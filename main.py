...
execute_rosenbrock(
    algs=[
        ...
        ("ourragd", {"L_dec": 0.9, "L_init": 1e3, "M_init": 1e1}),
        ("ourragd", {"L_dec": 0.9, "L_init": 1e4, "M_init": 1e1}),
        ("ourragd", {"L_dec": 0.9, "L_init": 1e2, "M_init": 1e2}),
        ("ourragd", {"L_dec": 0.9, "L_init": 1e3, "M_init": 1e2}),
        ("ourragd", {"L_dec": 0.9, "L_init": 1e4, "M_init": 1e2}),
        ("gd", {"L_dec": 0.9, "L_init": 1e2}),
        ("gd", {"L_dec": 0.9, "L_init": 1e3}),
        ("gd", {"L_dec": 0.9, "L_init": 1e4}),
        ("jnj2018", {"L": 1e2, "rho": 1e0}),
        ("jnj2018", {"L": 1e3, "rho": 1e0}),
        ("jnj2018", {"L": 1e4, "rho": 1e0}),
        ("jnj2018", {"L": 1e2, "rho": 1e1}),
        ("jnj2018", {"L": 1e3, "rho": 1e1}),
        ("jnj2018", {"L": 1e4, "rho": 1e1}),
        ("jnj2018", {"L": 1e2, "rho": 1e2}),
        ("jnj2018", {"L": 1e3, "rho": 1e2}),
        ("jnj2018", {"L": 1e4, "rho": 1e2}),
        ("ll2022", {"L": 1e2, "rho": 1e0}),
        ("ll2022", {"L": 1e3, "rho": 1e0}),
        ("ll2022", {"L": 1e4, "rho": 1e0}),
        ("ll2022", {"L": 1e2, "rho": 1e1}),
        ("ll2022", {"L": 1e3, "rho": 1e1}),
        ("ll2022", {"L": 1e4, "rho": 1e1}),
        ("ll2022", {"L": 1e2, "rho": 1e2}),
        ("ll2022", {"L": 1e3, "rho": 1e2}),
        ("ll2022", {"L": 1e4, "rho": 1e2}),
    ],
    timeout=10,
    tol_obj=1e-15,
    tol_grad=1e-15,
